...
func (o *RoleGroup) GetIdOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *RoleGroup) SetId(v int64) {
	o.Id = v
}

// GetIsMember returns the IsMember field value
func (o *RoleGroup) GetIsMember() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RoleGroup) GetIsMemberOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RoleGroup) SetIsMember(v bool) {
	o.IsMember = v
}
...
func (o *RoleGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varRoleGroup := _RoleGroup{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRoleGroup)

	if err != nil {
		return err
	}

	*o = RoleGroup(varRoleGroup)
