...
func NewUserGroupList(range_ Range, items []UserGroup) *UserGroupList {
	this := UserGroupList{}
	this.Range = range_
	this.Items = items
	return &this
...
func (o *UserGroupList) GetRange() Range {
	if o == nil {
		var ret Range
		return ret
	}
...
func (o *UserGroupList) GetRangeOk() (*Range, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Range, true
...
func (o *UserGroupList) SetRange(v Range) {
	o.Range = v
}

// GetItems returns the Items field value
func (o *UserGroupList) GetItems() []UserGroup {
	if o == nil {
		var ret []UserGroup
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UserGroupList) GetItemsOk() ([]UserGroup, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *UserGroupList) SetItems(v []UserGroup) {
	o.Items = v
}
