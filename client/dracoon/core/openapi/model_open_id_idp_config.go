...
// checks if the OpenIdIdpConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenIdIdpConfig{}
...
type _OpenIdIdpConfig OpenIdIdpConfig

// NewOpenIdIdpConfig instantiates a new OpenIdIdpConfig object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOpenIdIdpConfig(id int32) *OpenIdIdpConfig {
	this := OpenIdIdpConfig{}
	this.Id = id
...
// NewOpenIdIdpConfigWithDefaults instantiates a new OpenIdIdpConfig object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOpenIdIdpConfigWithDefaults() *OpenIdIdpConfig {
	this := OpenIdIdpConfig{}
	var pkceEnabled bool = false
	this.PkceEnabled = &pkceEnabled
	var userImportEnabled bool = false
...
func (o *OpenIdIdpConfig) GetId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *OpenIdIdpConfig) GetIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *OpenIdIdpConfig) SetId(v int32) {
	o.Id = v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *OpenIdIdpConfig) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetName(v string) {
	o.Name = &v
}

// GetIssuer returns the Issuer field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetIssuer() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetIssuerOk() (*string, bool) {
	if o == nil || IsNil(o.Issuer) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasIssuer() bool {
	if o != nil && !IsNil(o.Issuer) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetAuthorizationEndPointUrlOk() (*string, bool) {
	if o == nil || IsNil(o.AuthorizationEndPointUrl) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasAuthorizationEndPointUrl() bool {
	if o != nil && !IsNil(o.AuthorizationEndPointUrl) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetTokenEndPointUrlOk() (*string, bool) {
	if o == nil || IsNil(o.TokenEndPointUrl) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasTokenEndPointUrl() bool {
	if o != nil && !IsNil(o.TokenEndPointUrl) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetUserInfoEndPointUrlOk() (*string, bool) {
	if o == nil || IsNil(o.UserInfoEndPointUrl) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasUserInfoEndPointUrl() bool {
	if o != nil && !IsNil(o.UserInfoEndPointUrl) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetJwksEndPointUrlOk() (*string, bool) {
	if o == nil || IsNil(o.JwksEndPointUrl) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasJwksEndPointUrl() bool {
	if o != nil && !IsNil(o.JwksEndPointUrl) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetJwksEndPointUrl(v string) {
	o.JwksEndPointUrl = &v
}

// GetClientId returns the ClientId field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetClientId() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetClientIdOk() (*string, bool) {
	if o == nil || IsNil(o.ClientId) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasClientId() bool {
	if o != nil && !IsNil(o.ClientId) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetClientId(v string) {
	o.ClientId = &v
}

// GetClientSecret returns the ClientSecret field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetClientSecret() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetClientSecretOk() (*string, bool) {
	if o == nil || IsNil(o.ClientSecret) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasClientSecret() bool {
	if o != nil && !IsNil(o.ClientSecret) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetClientSecret(v string) {
	o.ClientSecret = &v
}

// GetFlow returns the Flow field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetFlow() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetFlowOk() (*string, bool) {
	if o == nil || IsNil(o.Flow) {
		return nil, false
	}
	return o.Flow, true
...
func (o *OpenIdIdpConfig) HasFlow() bool {
	if o != nil && !IsNil(o.Flow) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetFlow(v string) {
	o.Flow = &v
}

// GetScopes returns the Scopes field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetScopes() []string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetScopesOk() ([]string, bool) {
	if o == nil || IsNil(o.Scopes) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasScopes() bool {
	if o != nil && !IsNil(o.Scopes) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetScopes(v []string) {
	o.Scopes = v
}

// GetRedirectUris returns the RedirectUris field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetRedirectUris() []string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetRedirectUrisOk() ([]string, bool) {
	if o == nil || IsNil(o.RedirectUris) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasRedirectUris() bool {
	if o != nil && !IsNil(o.RedirectUris) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetRedirectUris(v []string) {
	o.RedirectUris = v
}

// GetPkceEnabled returns the PkceEnabled field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetPkceEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetPkceEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.PkceEnabled) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasPkceEnabled() bool {
	if o != nil && !IsNil(o.PkceEnabled) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetPkceEnabled(v bool) {
	o.PkceEnabled = &v
}

// GetPkceChallengeMethod returns the PkceChallengeMethod field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetPkceChallengeMethod() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetPkceChallengeMethodOk() (*string, bool) {
	if o == nil || IsNil(o.PkceChallengeMethod) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasPkceChallengeMethod() bool {
	if o != nil && !IsNil(o.PkceChallengeMethod) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetMappingClaimOk() (*string, bool) {
	if o == nil || IsNil(o.MappingClaim) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasMappingClaim() bool {
	if o != nil && !IsNil(o.MappingClaim) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetMappingClaim(v string) {
	o.MappingClaim = &v
}

// GetFallbackMappingClaim returns the FallbackMappingClaim field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetFallbackMappingClaim() string {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetFallbackMappingClaimOk() (*string, bool) {
	if o == nil || IsNil(o.FallbackMappingClaim) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasFallbackMappingClaim() bool {
	if o != nil && !IsNil(o.FallbackMappingClaim) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetUserInfoSourceOk() (*string, bool) {
	if o == nil || IsNil(o.UserInfoSource) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasUserInfoSource() bool {
	if o != nil && !IsNil(o.UserInfoSource) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetUserInfoSource(v string) {
	o.UserInfoSource = &v
}

// GetUserImportEnabled returns the UserImportEnabled field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetUserImportEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetUserImportEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.UserImportEnabled) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasUserImportEnabled() bool {
	if o != nil && !IsNil(o.UserImportEnabled) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetUserImportGroupOk() (*int64, bool) {
	if o == nil || IsNil(o.UserImportGroup) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasUserImportGroup() bool {
	if o != nil && !IsNil(o.UserImportGroup) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetUserImportGroup(v int64) {
	o.UserImportGroup = &v
}

// GetUserUpdateEnabled returns the UserUpdateEnabled field value if set, zero value otherwise.
func (o *OpenIdIdpConfig) GetUserUpdateEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetUserUpdateEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.UserUpdateEnabled) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasUserUpdateEnabled() bool {
	if o != nil && !IsNil(o.UserUpdateEnabled) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *OpenIdIdpConfig) GetUserManagementUrlOk() (*string, bool) {
	if o == nil || IsNil(o.UserManagementUrl) {
		return nil, false
	}
...
func (o *OpenIdIdpConfig) HasUserManagementUrl() bool {
	if o != nil && !IsNil(o.UserManagementUrl) {
		return true
	}
...
func (o *OpenIdIdpConfig) SetUserManagementUrl(v string) {
	o.UserManagementUrl = &v
}

func (o OpenIdIdpConfig) MarshalJSON() ([]byte, error) {
...
func (o OpenIdIdpConfig) ToMap() (map[string]interface{}, error) {
...
func (o *OpenIdIdpConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenIdIdpConfig := _OpenIdIdpConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpenIdIdpConfig)

	if err != nil {
		return err
	}

	*o = OpenIdIdpConfig(varOpenIdIdpConfig)

	return err
}

type NullableOpenIdIdpConfig struct {
	value *OpenIdIdpConfig
	isSet bool
}

func (v NullableOpenIdIdpConfig) Get() *OpenIdIdpConfig {
	return v.value
}

func (v *NullableOpenIdIdpConfig) Set(val *OpenIdIdpConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenIdIdpConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenIdIdpConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenIdIdpConfig(val *OpenIdIdpConfig) *NullableOpenIdIdpConfig {
	return &NullableOpenIdIdpConfig{value: val, isSet: true}
}

func (v NullableOpenIdIdpConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenIdIdpConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
