...
// checks if the UpdateSharesPasswordPolicies type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSharesPasswordPolicies{}
...
// NewUpdateSharesPasswordPolicies instantiates a new UpdateSharesPasswordPolicies object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateSharesPasswordPolicies() *UpdateSharesPasswordPolicies {
	this := UpdateSharesPasswordPolicies{}
	return &this
}

// NewUpdateSharesPasswordPoliciesWithDefaults instantiates a new UpdateSharesPasswordPolicies object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdateSharesPasswordPoliciesWithDefaults() *UpdateSharesPasswordPolicies {
	this := UpdateSharesPasswordPolicies{}
	return &this
}

// GetCharacterRules returns the CharacterRules field value if set, zero value otherwise.
func (o *UpdateSharesPasswordPolicies) GetCharacterRules() CharacterRules {
...
func (o *UpdateSharesPasswordPolicies) GetCharacterRulesOk() (*CharacterRules, bool) {
	if o == nil || IsNil(o.CharacterRules) {
		return nil, false
	}
...
func (o *UpdateSharesPasswordPolicies) HasCharacterRules() bool {
	if o != nil && !IsNil(o.CharacterRules) {
		return true
	}
...
func (o *UpdateSharesPasswordPolicies) SetCharacterRules(v CharacterRules) {
	o.CharacterRules = &v
}

// GetMinLength returns the MinLength field value if set, zero value otherwise.
func (o *UpdateSharesPasswordPolicies) GetMinLength() int32 {
...
// and a boolean to check if the value has been set.
func (o *UpdateSharesPasswordPolicies) GetMinLengthOk() (*int32, bool) {
	if o == nil || IsNil(o.MinLength) {
		return nil, false
	}
...
func (o *UpdateSharesPasswordPolicies) HasMinLength() bool {
	if o != nil && !IsNil(o.MinLength) {
		return true
	}
...
func (o *UpdateSharesPasswordPolicies) SetMinLength(v int32) {
	o.MinLength = &v
}

// GetRejectDictionaryWords returns the RejectDictionaryWords field value if set, zero value otherwise.
func (o *UpdateSharesPasswordPolicies) GetRejectDictionaryWords() bool {
...
// and a boolean to check if the value has been set.
func (o *UpdateSharesPasswordPolicies) GetRejectDictionaryWordsOk() (*bool, bool) {
	if o == nil || IsNil(o.RejectDictionaryWords) {
		return nil, false
	}
...
func (o *UpdateSharesPasswordPolicies) HasRejectDictionaryWords() bool {
	if o != nil && !IsNil(o.RejectDictionaryWords) {
		return true
	}
...
func (o *UpdateSharesPasswordPolicies) SetRejectDictionaryWords(v bool) {
	o.RejectDictionaryWords = &v
}

// GetRejectUserInfo returns the RejectUserInfo field value if set, zero value otherwise.
func (o *UpdateSharesPasswordPolicies) GetRejectUserInfo() bool {
...
// and a boolean to check if the value has been set.
func (o *UpdateSharesPasswordPolicies) GetRejectUserInfoOk() (*bool, bool) {
	if o == nil || IsNil(o.RejectUserInfo) {
		return nil, false
	}
...
func (o *UpdateSharesPasswordPolicies) HasRejectUserInfo() bool {
	if o != nil && !IsNil(o.RejectUserInfo) {
		return true
	}
...
func (o *UpdateSharesPasswordPolicies) SetRejectUserInfo(v bool) {
	o.RejectUserInfo = &v
}

// GetRejectKeyboardPatterns returns the RejectKeyboardPatterns field value if set, zero value otherwise.
func (o *UpdateSharesPasswordPolicies) GetRejectKeyboardPatterns() bool {
...
// and a boolean to check if the value has been set.
func (o *UpdateSharesPasswordPolicies) GetRejectKeyboardPatternsOk() (*bool, bool) {
	if o == nil || IsNil(o.RejectKeyboardPatterns) {
		return nil, false
	}
...
func (o *UpdateSharesPasswordPolicies) HasRejectKeyboardPatterns() bool {
	if o != nil && !IsNil(o.RejectKeyboardPatterns) {
		return true
	}
...
func (o *UpdateSharesPasswordPolicies) SetRejectKeyboardPatterns(v bool) {
	o.RejectKeyboardPatterns = &v
}

func (o UpdateSharesPasswordPolicies) MarshalJSON() ([]byte, error) {
...
func (o UpdateSharesPasswordPolicies) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateSharesPasswordPolicies struct {
	value *UpdateSharesPasswordPolicies
	isSet bool
}

func (v NullableUpdateSharesPasswordPolicies) Get() *UpdateSharesPasswordPolicies {
	return v.value
}

func (v *NullableUpdateSharesPasswordPolicies) Set(val *UpdateSharesPasswordPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSharesPasswordPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSharesPasswordPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSharesPasswordPolicies(val *UpdateSharesPasswordPolicies) *NullableUpdateSharesPasswordPolicies {
	return &NullableUpdateSharesPasswordPolicies{value: val, isSet: true}
}

func (v NullableUpdateSharesPasswordPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSharesPasswordPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
