...
func NewCustomerList(range_ Range, items []Customer) *CustomerList {
	this := CustomerList{}
	this.Range = range_
	this.Items = items
	return &this
...
func (o *CustomerList) GetRange() Range {
	if o == nil {
		var ret Range
		return ret
	}
...
func (o *CustomerList) GetRangeOk() (*Range, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Range, true
...
func (o *CustomerList) SetRange(v Range) {
	o.Range = v
}

// GetItems returns the Items field value
func (o *CustomerList) GetItems() []Customer {
	if o == nil {
		var ret []Customer
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CustomerList) GetItemsOk() ([]Customer, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *CustomerList) SetItems(v []Customer) {
	o.Items = v
}
