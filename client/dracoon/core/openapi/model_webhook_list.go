...
func NewWebhookList(range_ Range, items []Webhook) *WebhookList {
	this := WebhookList{}
	this.Range = range_
	this.Items = items
	return &this
...
func (o *WebhookList) GetRange() Range {
	if o == nil {
		var ret Range
		return ret
	}
...
func (o *WebhookList) GetRangeOk() (*Range, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Range, true
...
func (o *WebhookList) SetRange(v Range) {
	o.Range = v
}

// GetItems returns the Items field value
func (o *WebhookList) GetItems() []Webhook {
	if o == nil {
		var ret []Webhook
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebhookList) GetItemsOk() ([]Webhook, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *WebhookList) SetItems(v []Webhook) {
	o.Items = v
}
